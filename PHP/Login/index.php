                ...
                <div class="second-column">
                    ...
                    <form action="../Cadastro/cadastro.php" method="POST" class="form">
                        <label class="label-input" for="">
                            ...
                            <input type="text" placeholder="Nome" name="user_c" require>
                        </label>
                        
                        <label class="label-input" for="">
                            <i class="fas fa-envelope icon-modify"></i>
                            <input type="email" placeholder="Email" name="email_c" require>
                        </label>
                        
                        <label class="label-input" for="">
                            <i class="fas fa-lock icon-modify"></i>
                            <input type="password" placeholder="Senha" name="senha_c" require>
                        </label>
            ...
            <div class="content second-content">
                ...
                <div class="second-column"> 
                    ...
                    <form action="login.php" method="POST" class="form">
                        ...
                        <label class="label-input" for="">
                            <i class="fas fa-user icon-modify"></i>
                            <input name="usuario" type="text" placeholder="Usuário" class="form-control" require>
                            <i class="fas icon-modify" id="resultUser"></i>
                        </label>
                    
                        <label class="label-input" for="">
                            <i class="fas fa-lock icon-modify"></i>
                            <input name="senha" type="password" placeholder="Senha" class="form-control" require>
