...
export function ProgressiveImg ({ src, alt, loadingWidth, loadingHeight, color='#F3B72B', flexibleColor }){
    ...
    return typeSvg ?(
        <svg viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg" id='defaultProfileImage'>
            <circle cx="26.5" cy="26.5" r="26.5" fill={flexibleColor ? color : 'var(--admin-color)'}/>
